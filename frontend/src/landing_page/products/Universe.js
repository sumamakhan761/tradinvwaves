  ...
  return (
    <div className='container mt-5 text-center' >
      <div className='row'>
        ...
        <div className='col-lg-4 col-md-4 col-sm-12 p-3' data-aos="fade-zoom-in"
        ...
        <div className='col-lg-4 col-md-4  p-3' data-aos="fade-zoom-in"
          data-aos-easing="ease-in-back"
          data-aos-delay="310"
          data-aos-offset="0">
        ...
        <div className='col-lg-4 col-md-4 p-3 mt-5' data-aos="fade-zoom-in"
          data-aos-easing="ease-in-back"
          data-aos-delay="330"
          data-aos-offset="0">
